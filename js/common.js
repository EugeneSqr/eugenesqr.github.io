...
(function (define) {
		...
		function put(topReferenceElement) {
			...
			function insertLastElement() {
				...
				if (current && referenceElement && current != referenceElement) {
					...
					? fragment : referenceElement).insertBefore(current, nextSibling || null); // do the actual insertion
				}
			}
	...
	if ("function" === "function") {
		// AMD loader
		System.registerDynamic("node_modules/put-selector/put.js", [], false, function ($__require, $__exports, $__module) {
			return (function () {
				return factory();
			}).call(this);
		});
...
(function () {
  ...
  if (typeof module !== 'undefined' && module.exports) {
    ...
    System.registerDynamic('node_modules/showdown/dist/showdown.js', [], false, function ($__require, $__exports, $__module) {
      return (function () {
        'use strict';
